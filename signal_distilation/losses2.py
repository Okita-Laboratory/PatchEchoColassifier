...
# All rights reserved.
"""
Implements the knowledge distillation loss with additional EMD-based loss for `soft2`, JS divergence loss for `soft3`, and hinge loss for `soft4` distillation types
"""
import torch
